...
<?php
// 配置区
$dir = '/so/'; // 自定义文件所在目录，例如想把文件放在根目录下 a 目录，'/' 改为 '/a/'
...
$https = 1; // 如果是 https 网站 请把 0 改为 1
...
echo '        <form method="get" action="'.$url.'">
            ...
            <script type="text/javascript">var canvas=document.getElementById("myCanvas");if(canvas.getContext){var ctx=canvas.getContext("2d");ctx.font="22px Helvetica Neue";ctx.fillStyle="#FF6347";ctx.fillText("鹦鹉",0,24);};</script>
';
